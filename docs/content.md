...
- 기획 인터뷰 지침과 문서 템플릿이 담긴 `docs/` 폴더
- AI 인터뷰 진행 규칙 `docs/지침.md`
- 강사가 작성한 예시 문서
...
3. `docs/지침.md`를 AI에게 읽게 하고, 기획 인터뷰를 진행한다.
4. AI가 질문하면 답변하고 서비스 기획안, 디자인 시스템, PRD, 유저플로우, 기능정의서를 채운다.
5. 문서가 정리되면 `프롬프트-치트시트.md`를 참고해 화면과 기능을 하나씩 만든다.
...
그다음 docs/지침.md에 따라 내가 만들 앱을 정할 수 있도록 인터뷰를 진행해줘.
질문은 한 번에 3~5개씩만 해줘.
내가 답하면 그 내용을 바탕으로 docs/서비스-기획안.md, docs/디자인-시스템.md, docs/PRD.md, docs/유저플로우.md, docs/기능정의서.md를 초안으로 채워줘.
